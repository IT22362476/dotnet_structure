...
namespace Inv.Domain.Configarations
{
    public class WarehouseConfiguration : IEntityTypeConfiguration<Warehouse>
    {
        ...
        {
            builder.HasKey(c => c.WHSerialID);

            builder.Property(e => e.WHID).HasDefaultValueSql("NEXT VALUE FOR dbo.WHID");

            builder.HasIndex(c => c.WHID).IsUnique();

            builder.HasIndex(c => c.WHSerialID).IsUnique();
