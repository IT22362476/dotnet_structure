...
namespace Inv.Application.Features.GRN.Queries
{
    ...
    public class GetGRNsWithPaginationQueryHandler : IRequestHandler<GetGRNsWithPaginationQuery, Result<PaginatedResult<GetPaginatedGRNHeadersDto>>>
    {
        ...
        public async Task<Result<PaginatedResult<GetPaginatedGRNHeadersDto>>> Handle(GetGRNsWithPaginationQuery query, CancellationToken cancellationToken)
        {
            ...
            var sql = @"
                        ...
                        WHERE 1 = 1 AND grn.CompSerialID=@fromCompID AND grn.ApprovedBy IS NULL AND grn.IsDeleted = 0";
