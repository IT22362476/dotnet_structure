...
namespace Inv.Persistence.Migrations
{
    ...
    [Migration("20250417121049_CreateIndexesInGRNTables")]
    partial class CreateIndexesInGRNTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inv.Domain.Entities.SystemPODetail", b =>
                {
                    b.Property<int>("SystemPODetailSerialID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SystemPODetailSerialID"));

                    b.Property<bool>("Active")
                        .HasColumnType("bit");

                    b.Property<decimal>("BalToReceive")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("SystemPOHeaderSerialID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SystemPODetailSerialID");

                    b.HasIndex("IsDeleted")
                        .HasFilter("[IsDeleted] = 1");

                    b.HasIndex("SystemPOHeaderSerialID");

                    b.ToTable("SystemPODetail", "Inv");
                });

            modelBuilder.Entity("Inv.Domain.Entities.SystemPOHeader", b =>
                {
                    b.Property<int>("SystemPOHeaderSerialID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SystemPOHeaderSerialID"));
                    ...
                    b.Property<int>("BillingLocationSerialID")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IncotermSerialID")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PayTermSerialID")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SystemPOID")
                        .HasColumnType("int");

                    b.HasKey("SystemPOHeaderSerialID");

                    b.HasIndex("IsDeleted")
                        .HasFilter("[IsDeleted] = 1");

                    b.ToTable("SystemPOHeader", "Inv");
                });
            ...
            modelBuilder.Entity("Inv.Domain.Entities.SystemPODetail", b =>
                {
                    b.HasOne("Inv.Domain.Entities.SystemPOHeader", "SystemPOHeader")
                        .WithMany("SystemPODetails")
                        .HasForeignKey("SystemPOHeaderSerialID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SystemPOHeader");
                });
