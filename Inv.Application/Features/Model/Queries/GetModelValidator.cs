...
namespace Inv.Application.Features.Model.Queries
{
    public class GetModelValidator : AbstractValidator<GetModelDto>
    {
        public GetModelValidator()
        {
            ...
            RuleFor(x => x.ModelName)
             ...
             .NotNull().WithMessage("v can not be null");
